...
val coronaAppPackage = project.findProperty("coronaAppPackage") as? String ?: "com.pushsolar2d.huawei"
...
//            }
    ...
    buildTypes {
        getByName("release") {
            ...
            coronaKeystore?.let { signingConfig = signingConfigs.getByName("debug") }
        }
...
tasks.register<Copy>("exportToNativeAppTemplate") {
    ...
    from(rootDir) {
        ...
        filter {
            it.replace("com.mycompany.app", "com.pushsolar2d.huawei")
        }
    }
